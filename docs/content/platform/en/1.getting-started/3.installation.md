...
Head over to the [Edition](/docs/platform/en/concepts/edition) guide to learn how content, routing, frontmatter, and MDC syntax work in TockDocs.
::
...
- the `i18n` starter uses **legacy mode + i18n** with locale folders such as `content/en` and `content/fr`
...
::tip{to="/docs/platform/en/getting-started/project-structure"}
