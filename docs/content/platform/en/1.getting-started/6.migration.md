...
- **knowledge-base mode** when you want multiple KBs like `/docs/platform/en/...` and `/docs/parser/en/...`
...
Once content is moved, review the [Configuration](/docs/platform/en/concepts/configuration), [Assistant](/docs/platform/en/ai/assistant), and [MCP](/docs/platform/en/ai/mcp) guides to align your app with current TockDocs conventions.
::
