...
This is where you [write pages](/docs/platform/en/concepts/edition) in Markdown. Docus automatically generates routes based on your file structure.
...
This is where you can [configure Docus](/docs/platform/en/concepts/configuration) to fit your branding, handle SEO, set your locale, and adapt links and socials.
