...
:site-image{.rounded-md.w-full alt="og image documentation page" src="/_og/s/c_Docs,headline_Core+Concepts,title_Configuration,description_Customize+your+TockDocs+documentation+from+Nuxt+application+configuration+file.,p_Ii9kb2NzL3BsYXRmb3JtL2VuL2NvbmNlcHRzL2NvbmZpZ3VyYXRpb24i.png"}
...
:site-image{.rounded-md.w-full alt="og image landing page" src="/_og/s/c_Landing,title_TockDocs,description_An+AI-powered+Knowledge+Management+System.png"}
