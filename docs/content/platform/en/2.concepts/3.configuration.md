...
::tip{to="/docs/platform/en/concepts/edition#frontmatter"}
...
::tip{to="/docs/platform/en/concepts/internationalization"}
For multi-language documentation with language switching, see the [Internationalization guide](/docs/platform/en/concepts/internationalization).
::
...
::tip{to="/docs/platform/en/getting-started/studio"}
