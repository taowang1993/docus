...
Docus prend en charge **Vercel AI Gateway**, ainsi que :
...
export default defineAppConfig({
  assistant: {
    faqQuestions: [
      {
        category: 'Démarrage',
        items: ['Comment installer Docus ?', 'Quelle est la structure du projet ?'],
      },
      {
...
Par défaut, Docus préfère Vercel AI Gateway lorsque ses identifiants sont disponibles. Vous pouvez forcer explicitement le provider :
