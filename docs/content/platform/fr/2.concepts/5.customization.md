...
::u-button{color="neutral" icon="i-lucide-code-xml" to="https://github.com/taowang1993/tockdocs/blob/main/layer/app/components/docs/DocsPageHeaderLinks.vue" variant="link"}
Code du composant par défaut
::
...
::u-button{color="neutral" icon="i-lucide-code-xml" to="https://github.com/taowang1993/tockdocs/blob/main/layer/app/components/docs/DocsAsideRightBottom.vue" variant="link"}
Code du composant par défaut
::
