...
description: Créez une documentation multilingue avec le support i18n intégré de Docus.
navigation:
  icon: i-lucide-globe
seo:
  description: Apprenez à configurer et gérer une documentation multilingue avec le support i18n intégré de Docus.
  title: Internationalisation
---

Docus introduit un **support d'internationalisation natif** basé sur le module `@nuxtjs/i18n`, vous permettant de créer une documentation en plusieurs langues avec un routage automatique et une gestion de contenu.
