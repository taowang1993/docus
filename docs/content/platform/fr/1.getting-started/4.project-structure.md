...
C'est ici que vous [rédigez vos pages](/docs/platform/fr/concepts/edition) en Markdown. Docus génère automatiquement les routes basées sur votre structure de fichiers.
...
C'est ici que vous pouvez [configurer Docus](/docs/platform/fr/concepts/configuration) pour l'adapter à votre marque, gérer le SEO, définir votre locale et adapter les liens et réseaux sociaux.
