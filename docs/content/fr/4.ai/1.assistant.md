...
Sur Vercel avec OIDC, supprimez la variable d'environnement système auto-injectée dans les paramètres du projet si vous ne souhaitez pas activer Vercel AI Gateway.
